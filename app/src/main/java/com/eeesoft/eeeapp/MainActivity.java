...
public class MainActivity extends ActionBarActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    int[] photos={R.drawable.demos, R.drawable.blogs,R.drawable.home_screen};
...
//    }
    ...
    public void onPageSelected(int position) {
        ...
        if(position==1) {
            imageView.setImageResource(R.drawable.company_85);
            transparentImage.setImageResource(R.color.red_transparent);
        }
        if(position==2) {
            imageView.setImageResource(R.drawable.solutions_85);
        ...
        if(position==4) {
            imageView.setImageResource(R.drawable.demos_85);
            transparentImage.setImageResource(R.color.purple_transparent);
        }
        if(position==5) {
            imageView.setImageResource(R.drawable.blog_img_85);
