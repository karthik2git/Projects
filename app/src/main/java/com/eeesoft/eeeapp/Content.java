...
public  List<Data> fill_moodlemobileapp()
{
    ...
    {
        List<Data> data = new ArrayList<>();
        String tempTitle = "<html><body><ul><li>India-based localization, taxes and logistics integration with table rate implementation</li><li>Bootstrap Responsive Theme</li><li>Live customer chat and analytics</li><li>Customer tracking based “Related Products”</li><li>Integrated product enquiry management</li><li>Twitter feed integration</li><li>Integration with Fedex Shipping Services</li></ul></div></body></html>";
        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("JEWELSKART",tempTitle,R.drawable.jewelskart));
        return data;
    }
  public List<Data>  fill_multikart()
  {
      List<Data> data = new ArrayList<>();
      String tempTitle ="<html><body><ul><li>Multi-vendor marketplace</li><li>Adaptive Paypal payments for percentage-based real-time revenue sharing between Store Owner and Vendors</li><li>Self-customizable vendor profile</li><li>Vendor &amp; product approval management</li><li>Vendor ratings and feedbacks</li><li>Social media connect for Store and Vendors</li></ul></div></body></html>";
      Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
      data.add(new Data("MULTIKART",tempTitle,R.drawable.multikart));
      return data;
  }
    public List<Data>  fill_bookskart()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Integration with Measured Search for advanced cloud based indexing, search and auto complete</li><li>Infinite scroll on product lists</li><li>Customer tracking based related products</li><li>Sidebar sorting</li><li>Unlimited downloaded size</li><li>Social Media share options product description page</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("BOOKSKART",tempTitle,R.drawable.bookskart));
        return data;
    }
    public List<Data>  fill_digitalkart()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Download limits</li><li>Responsive theme</li><li>Download link encoding</li><li>Unlimited downloaded size</li><li>Home page carousels and product image zoom</li><li>Download link encoding</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("DIGITALKART",tempTitle,R.drawable.digitalkart));
        return data;
    }
    public List<Data>  fill_wookart()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Woocommerce based Multi vendor store</li><li>Automatic currency conversion based on user location</li><li>Predictive search with thumbnails</li><li>Analytics based product recommendation</li><li>Product reviews and buyer follow-up</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("WOOKART",tempTitle,R.drawable.wookart));
        return data;
    }
    public List<Data>  fill_ecourses()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Personalised Dashboard</li><li>Collaborative tools and activities</li><li>All-in-one calendar</li><li>Secure authentication and mass enrolment</li><li>Bulk course creation and easy backup</li><li>Detailed reporting and logs</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("ECOURSES",tempTitle,R.drawable.ecourses));
        return data;
    }
    public List<Data>  fill_sharedlms()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>A single Moodle system shared between multiple Universities</li><li>Personalised Dashboard</li><li>Collaborative tools and activities</li><li>Bulk course creation and easy backup</li><li>Detailed reporting and logs</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("SHAREDLMS",tempTitle,R.drawable.sharedlms));
        return data;
    }
    public List<Data>  fill_schoollms()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Designed for K-12 schools</li><li>Site-level analytics</li><li>User engagement analytics</li><li>Bulk course creation and easy backup</li><li>Virtual classroom integration</li><li>Collaborative tools and activities</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("SCHOOLLMS",tempTitle,R.drawable.schoollms));
        return data;
    }
    public List<Data>  edukart_lms()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Magento and Moodle integration</li><li>Single Sign On, account sync and course auto enrolment&nbsp;in Magento and Moodle systems</li><li>Create SCORM compatible courses in Moodle and use the shopping cart in Magento to sell</li><li>Date validation of Moodle courses in Magento</li><li>Gift Cards</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("EDUKARTLMS",tempTitle,R.drawable.edukart));
        return data;
    }
    public List<Data>  wookart_lms()
    {
        List<Data> data = new ArrayList<>();
        String tempTitle ="<html><body><ul><li>Integration of&nbsp;WooCommerce and Moodle</li><li>Single-Sign On and course auto enrollment</li><li>Payment gateways integration with&nbsp;Paypal, Pay U Money, CCAVENUE and PayTM</li><li>Auto course&nbsp;synchronization in Magento</li><li>User Analytics for both eCommerce and eLearning Systems.</li></ul></body></html>";

        Spanned htmlAsSpanned = Html.fromHtml(tempTitle);
        data.add(new Data("WOOKARTLMS",tempTitle,R.drawable.wookartlms));
        return data;
    }
}